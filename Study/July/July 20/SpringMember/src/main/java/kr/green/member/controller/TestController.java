	...
	public String sendMail() {
		...
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
			public void prepare(MimeMessage mimeMessage) throws Exception {
				mimeMessage.setFrom("top2blue@naver.com");// 보내는 사람 아이디
				mimeMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("ithuman202204@gmail.com"));// 받는 사람 아이디
