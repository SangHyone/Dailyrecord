...
@Setter
@ToString
@EqualsAndHashCode // 내가 만든 클래스가 Set에서 사용될 가능성이 조금이라도 있으면 반드시 해줘야한다.
public class Person implements Comparable<Person> {
	...
	public int compareTo(Person o) {
		...
		// 이름 오름차순 나이 내림차순 이라면 어떻게 할까요?
		return this.name.equals(o.name) ? o.age - this.age : this.name.compareTo(o.name);
	}
