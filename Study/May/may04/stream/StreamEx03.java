...
public class StreamEx03 {
	public static void main(String[] args) {
		...
		// 20~30 출력
		// limit(개수) : 개수제한 중간 연산
		Stream.iterate(20, n->n+1).limit(10).forEach(n->System.out.print(n+ " "));
		System.out.println();
		...
		.skip(100) // 건너띄기
		.limit(10)
		.filter(n->n%3==0)	// 정적 메서드를 이용하여 걸러서 : 중간연산
		.forEach(n->System.out.println(n+" "));
		System.out.println();
		...
		new Random().ints().limit(10).forEach(n->System.out.println(n+ " "));
		System.out.println();
		new Random().ints(1,101).limit(10).forEach(n->System.out.println(n+ " "));
		System.out.println();
		new Random().ints(5,100,201).forEach(n->System.out.println(n+ " "));
		System.out.println();
	}
	static int cnt=1;
