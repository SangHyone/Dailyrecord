...
public class ListEx02 {
	public static void main(String[] args) {
		...
		// Vector클래스는 옛부터 지원되는 클래스로 멀티쓰레드에 안전하게 설계되었다.
		// 싱글쓰레드에 적합하게 개량된 리스트는 ArrayList, LinkedList...등이 있다.
		// 성능 개선된 클래스 들에는 Element가 들어간 메서드 들은 삭제되었다. capacity()도 삭제됨
		...
		/*
		// 앞에서부터 지우면 인덱스 값이 변경되어 당겨 지므로 삭제되지 않는 값이 생긴다.
