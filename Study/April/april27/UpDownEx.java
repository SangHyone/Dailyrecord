...
public class UpDownEx {
	public static void main(String[] args) {
		...
		//Down douwn2 = new Up(); // 자식의 타입에 부모의 객체를 대입하면 에러
		//Down douwn2 = (Down) new Up(); // 자식의 타입에 부모의 객체를 형변환 해서 대입하면가능!! 하지만 실행에러!!
									   // ClassCastException 예외 발생!!
		
		Up up2 = new Down(); // 부모타입의 변수에 자식의 객체 대입 가능!! ==> UpCasting
		up2.show(); // 자식의 메서드가 호출된다.
		
		Down down2 = (Down)up2; // up2가 Up타입이지만 실제 자식의 타입을 가리키고 있어서 예외 발생하지 않는다.
