...
class WinClose extends WindowAdapter{
	...
	public void windowClosing(WindowEvent e) {
		...
		System.exit(0);// 프로그램 강제 종료!! 숫자는 0은 정상 종료 -1은 비정상 종료
	}
...
public class WinEx {
	...
	public static void main(String[] args) {
		...
		frame.setSize(500, 500); // 크기지정
		frame.setLocationRelativeTo(null); // 화면 중앙에 나타나게하고
		
		// 윈도우가 닫힐때 프로그램도 종료하라고 지정
		//WinClose winClose = new WinClose();
		//frame.addWindowListener(winClose);
